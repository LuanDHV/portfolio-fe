export default function AboutSection() {
  return (
    <section id="about" className="relative min-h-screen py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          <div className="rounded-lg border border-white/10 bg-neutral-950/80 p-8 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
